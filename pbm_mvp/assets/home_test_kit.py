...
def main():
    # A4 Paper at 150 DPI is approx 1240 x 1754
    ...
    # Grids (5cm x 5cm approx 300px at 150DPI)
    square_size = 400
    spacing = 15
    
    layer_a = create_grid(square_size, spacing, 0, label="SQUARE A (BASE)")
    layer_b = create_grid(square_size, spacing, 7, label="SQUARE B (TOP)")
